...
// Spinning conic-gradient orb. Pure CSS via styled-jsx — no motion library.
// Honours `prefers-reduced-motion` by halting the spin. Used as the glowing
// mark inside the "Ask AI" launcher pill.
